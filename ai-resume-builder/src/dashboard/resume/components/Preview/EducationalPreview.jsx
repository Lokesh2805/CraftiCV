...
function EducationalPreview({resumeInfo}) {
  return (
    <div className='my-6'>
    <h2 className='font-bold text-center text-sm mb-2' style={{color: resumeInfo?.themeColor}}>Education</h2>
    ...
    {resumeInfo?.education.map((education, index)=>(
        <div key={index} className='my-5'>
            ...
            <span className=''>{education?.startDate} - {education?.endDate}</span></h2>
